...
**Status:** v0.2.3 — L402 (Lightning) and x402 (EVM) payment verification are both live. x402 verification and settlement are delegated to a standard x402 facilitator's `/verify` and `/settle` endpoints; see [open milestones](#status)
